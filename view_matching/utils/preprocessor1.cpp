...
void
preprocessor1::execute(const Graph *query_graph, const Graph *data_graph, catalog *storage, bool enable_elimination) {
...
void preprocessor1::initialize(const Graph *query_graph, const Graph *data_graph) {
...
void preprocessor1::scan_relation(catalog *storage) {
...
void preprocessor1::eliminate_dangling_tuples(catalog *storage) {
...
void preprocessor1::generate_preprocess_plan() {
...
edge_relation *preprocessor1::get_key_position_in_relation(uint32_t u, uint32_t v, catalog *storage, uint32_t &kp) {
    kp = 0;
...
void preprocessor1::print_metrics() {
