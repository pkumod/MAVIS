...
/**
 * Enable dot file output for debugging.
 * When enabled, .dot graph files will be written to the dot_file/ directory
 * (created automatically if it does not exist).
 */
// #define ENABLE_DOT_OUTPUT
#define OUTPUT_RESULT_NUM_LIMIT (1024 * 1024) * 100
